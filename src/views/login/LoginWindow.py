...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow: QtWidgets.QWidget):
        LoginWindow.setObjectName("LoginWindow")
        LoginWindow.resize(800, 600)
        LoginWindow.setMinimumWidth(500)
        LoginWindow.setMinimumHeight(400)
        LoginWindow.setMaximumWidth(1920)
        LoginWindow.setMaximumHeight(1080)
        ...
        LoginWindow.setLayout(self.horizontalLayout)

        # Авторство
        self.authorLabel = QtWidgets.QLabel(LoginWindow)
        self.authorLabel.setObjectName("authorLabel")
        self.authorLabel.setText("JKearnsl")
        self.authorLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeft)
        self.leftVerticalLayout.addWidget(self.authorLabel)

        # Версия
        self.versionLabel = QtWidgets.QLabel(LoginWindow)
        self.versionLabel.setObjectName("versionLabel")
        self.versionLabel.setText("Версия: 0.0.1")
        self.versionLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        self.secondVerticalLayout.addWidget(self.versionLabel)
        ...
        self.authTitleLabel = QtWidgets.QLabel(LoginWindow)
